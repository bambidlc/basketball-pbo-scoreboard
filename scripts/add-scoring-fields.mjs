...
const FIELD_PLAN = [
  {
    ...
    label: "Game",
    fields: [
      field("x_studio_period", "Period", "integer"),
      field("x_studio_game_clock_seconds", "Game Clock Seconds", "integer"),
      field("x_studio_shot_clock_seconds", "Shot Clock Seconds", "integer"),
      field("x_studio_possession_team", "Possession Team", "many2one", "x_team"),
      field("x_studio_home_timeouts", "Home Timeouts", "integer"),
      field("x_studio_away_timeouts", "Away Timeouts", "integer"),
      field("x_studio_home_team_fouls", "Home Team Fouls", "integer"),
      field("x_studio_away_team_fouls", "Away Team Fouls", "integer"),
      field("x_studio_game_events", "Game Events", "one2many", "x_game_event", "x_studio_game"),
      field("x_studio_stats", "Player Stats", "one2many", "x_player_game_stat", "x_studio_game"),
    ],
  },
  {
    model: "x_player_game_stat",
    label: "Player Game Stat",
    fields: [
      field("x_studio_assists", "Assists", "integer"),
      field("x_studio_off_rebounds", "Offensive Rebounds", "integer"),
      field("x_studio_def_rebounds", "Defensive Rebounds", "integer"),
      ...
      field("x_studio_2pa", "2PT Attempted", "integer"),
      field("x_studio_3pm", "3PT Made", "integer"),
      field("x_studio_3pa", "3PT Attempted", "integer"),
    ],
  },
  {
    createModel: true,
    ...
    fields: [
      ...
      field("x_studio_period", "Period", "integer"),
      field("x_studio_clock_seconds", "Clock Seconds", "integer"),
      field("x_studio_action_type", "Action Type", "char"),
      field("x_studio_points", "Points", "integer"),
      field("x_studio_score_after", "Score After", "char"),
      field("x_studio_shot_value", "Shot Value", "integer"),
      field("x_studio_shot_x", "Shot X", "integer"),
      field("x_studio_shot_y", "Shot Y", "integer"),
      field("x_studio_shot_zone", "Shot Zone", "char"),
      field("x_studio_note", "Note", "char"),
    ],
  },
];
...
console.log("Scoring field setup complete.");
